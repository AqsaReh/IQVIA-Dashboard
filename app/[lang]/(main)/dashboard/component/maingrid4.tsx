...
const rows: ColumnData[] = [
  { title: "Industory", mat: 2500, ytd: "Mark Dsuza Corp",   qtr: 803, mth: 1 },
  { title: "Highnoon",  mat: 1900, ytd: "Josef Jennyfer Corp", qtr: 712, mth: 2 },
  { title: "HNL-V",     mat: 3200, ytd: "Romeo D custa Corp", qtr: 900, mth: 3 },
  { title: "CXH",       mat: 2400, ytd: "Anald Donald Corp",  qtr: 939, mth: 4 },
  { title: "R2H",       mat: 4500, ytd: "Vicky Patel Corp",   qtr: 745, mth: 5 },
];

const PageSize = 5;

const MainGrid4: React.FC = () => {
                ...
                <tbody className="[&_tr:last-child]:border-1">
                  {pageRows.map((item, idx) => (
                    ...
                    >
                      ...
                      <td className="p-4 align-middle font-normal text-sm text-default-700 border-b border-default-100 dark:border-border last:text-end last:pr-6">
                        {Intl.NumberFormat().format(item.mat)}
                      </td>

                      <td className="p-4 align-middle font-normal text-sm text-default-700 border-b border-default-100 dark:border-border last:text-end last:pr-6">
                        <div className="truncate max-w-[260px]" title={item.ytd}>
                          {item.ytd}
                        </div>
                      </td>

                      <td className="p-4 align-middle font-normal text-sm text-default-700 border-b border-default-100 dark:border-border last:text-end last:pr-6">
                        {Intl.NumberFormat().format(item.qtr)}
                      </td>
